...
```javascript
import acoshBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acosh-by@v0.2.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acosh-by@v0.2.0-esm/index.mjs';
```
